...
async def start(client: Client, message: Message):
    buttons = ButtonMaker()
    buttons.button_link('Owner', f'https://t.me/rishisin07')
    buttons.button_link('Group', f'https://t.me/cinemaa_boxoffice_support')
...
async def restart(_, message: Message):
    ...
    if hrestart:
        ...
        _, msg = await gather(kill_route(), sendMessage('<i>Restarting bro wait if I did not respond from 2-3 min tag my broken 💔 baby @rishisin07...</i>', message))
